...
export async function GET(_request: NextRequest, { params }: { params: { locale: string } }): Promise<Response> {
  ...
  const pages = [
    { path: "/investor/report", priority: 0.7 },
    { path: "/investor/financial-information", priority: 0.7 },
    { path: "/investor/shares-information", priority: 0.7 },
    { path: "/investor/publications-for-investors", priority: 0.7 },
  ];
