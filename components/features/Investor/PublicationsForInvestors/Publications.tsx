...
function Pagination({
    ...
    return (
        <section
            className="mt-5 py-10 flex w-full justify-center lg:justify-between items-center gap-4 flex-col lg:flex-row ">
...
const navLinks: NavLink[] = [
    ...
    },
    {
        ...
        href: "/investor/publications-for-investors?tab=investor-update",
    },
];
                    ...
                    <div className="lg:col-span-4">
                        <div className="grid lg:grid-cols-2 gap-4 pb-10 border-b border-b-neutral-5 items-center">
                            ...
                            <div className="relative w-full lg:w-[264px] lg:ms-auto">
                                <div
                                    className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-7 pointer-events-none z-10">
                                    <Search size={16}/>
                                </div>
                                <input
                                    type="text"
                            ...
                            {isLoading ? (
                                ...
                                paginatedItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div
                                            className="flex flex-col lg:flex-row justify-start lg:justify-between w-full">
                                            <div
                                                className="flex items-center justify-start text-base text-neutral-8 gap-3 w-full">
                                            ...
                                            <div
                                                className="flex items-center justify-start lg:justify-end gap-8 w-full">
                                                <Link
                                                    title={item.title}
