...
export function ContactInfoCard({
  ...
  return (
    <div className="relative lg:max-h-[675px] lg:max-w-[456px] h-full w-full rounded-xl flex flex-col p-6 justify-between max-lg:min-h-[456px] overflow-hidden">
      <Image
        src={imageSrc}
        alt={imageAlt}
        layout="fill"
      ...
      <div className="relative z-10 rounded-xl border border-neutral-400 p-4 bg-white">
        <div className="mb-1 flex flex-col gap-2">
          <span className="text-[22px] text-[#2474A5] font-medium">
            {companyName}
          </span>
        ...
        <div className="flex flex-col gap-2">
          <address className="text-neutral-700 text-sm not-italic">
            {address}
          </address>
