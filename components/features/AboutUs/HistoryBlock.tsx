...
export const HistoryBlock: React.FC<HistoryBlockProps> = ({
  ...
  return (
    <div
      className="py-28 text-white bg-[#091A24] relative z-0 bg-no-repeat bg-[position:30%_center] lg:bg-[position:100%_center] bg-cover"
    ...
    >
      ...
      <section className="container mx-auto px-[1rem] lg:px-[1rem] xl:px-[3rem] 2xl:px-[6rem] relative z-[1]">
