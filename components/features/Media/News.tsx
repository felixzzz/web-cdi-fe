...
export function News({
    ...
    const totalPages = activeTab === "news" ? totalNewsPages : (activeTab === "blog" ? totalBlogPages : totalPressPages);
    const totalItems = activeTab === "news" ? totalNewsItems : (activeTab === "blog" ? totalBlogItems : totalPressItems);
            ...
            <nav className="flex items-center gap-2 mt-10 mb-6 overflow-x-auto">
                {categories.map((category) => (
                    <button
                        ...
                        style={{
                            display:
                                (activeTab === "press-release" || activeTab === "blog") && categories.length === 1
                                    ? "none"
                                    : "flex",
                        }}
                    >
            ...
            {activeTab === "press-release" && (
                <>
                    <div className="mt-10 mb-8 flex items-center justify-between flex-col lg:flex-row gap-4">
                        <button
                            className="text-xs lg:text-base cursor-pointer px-6 py-2 rounded-full whitespace-nowrap flex items-center gap-2 text-[#2474A5] border border-[#2474A5] hover:bg-[#2474A5] hover:text-white transition">
                            Filter <SlidersHorizontal size={18}/>
                        </button>
                        <div
                            className="w-full lg:w-[264px] rounded-full border border-neutral-300 px-4 py-2 flex items-center gap-2">
        ...
        >
            <article className="flex flex-col text-neutral-13 w-full">
                <div className="w-full aspect-square overflow-hidden">
                    <div
                        className="relative w-full h-full transition-transform duration-300 ease-in-out group-hover:scale-110">
                        {!imageUrl || hasError ? (
                            <div
                                className="w-full h-full flex flex-col items-center justify-center text-neutral-400 gap-2">
...
function Pagination({
    ...
    return (
        <section
            className="mt-5 py-10 flex w-full justify-center md:justify-between items-center gap-4 flex-col md:flex-row">
