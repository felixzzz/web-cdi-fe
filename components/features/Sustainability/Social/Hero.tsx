...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div
      className="relative overflow-hidden aspect-[4/5] md:aspect-[4/3] lg:aspect-video w-full py-[5%] lg:py-[8%] flex items-end bg-cover"
      ...
      <section className="container mx-auto  ">
        <div className="text-white grid lg:grid-cols-2 gap-2 relative z-[1] items-end">
          <div>
            ...
            <div
              className="max-w-2xl prose prose-invert prose-base  text-xs sm:text-sm lg:text-base text-white leading-snug lg:leading-loose text-justify"
